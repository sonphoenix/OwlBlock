...
execute_process(
  COMMAND "C:/devkitPro/msys2/usr/bin/git.exe" --git-dir=.git show-ref "main"
  WORKING_DIRECTORY "C:/Users/MSI/source/repos/Owl BLock/out/build/x64-Release/_deps/rlimgui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/MSI/source/repos/Owl BLock/out/build/x64-Release/_deps/rlimgui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/MSI/source/repos/Owl BLock/out/build/x64-Release/_deps/rlimgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
